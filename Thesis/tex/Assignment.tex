...
When an equiplets needs reconfiguration, this will impact products that needs producing, especially schedules of these products will be affected. There was no scheduling alogrithm implemented in REXOS before the project. The project leader's decision was that a scheduling algorigthm in REXOS was more important than reconfiguration of an equiplet. A scheduling algorithm for REXOS was already researched and described in paper: 'Multiagent-based agile manufacturing\cite{PAPER70}'. This resulted in the following new research questions:
...
Another research question came up during the project that had a high priority. During brainstorm sessions question came up concerning if REXOS should have a Hierarchical or Heterarchical setup. Stated was that both setups had its own advantages and disadvantages. Choosing a right setup is neccesary. It is possible that switching between both setups could be feasible too.
...
The addition of this new research question resulted in a lower priority of the 'performance and stability' research question.
%==================================Goals===================================%
\section{Goals}
