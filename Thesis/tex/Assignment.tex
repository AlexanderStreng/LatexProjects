...
The subtasks in this project are defined to be the stabilisation of the platform and the testing of performance. This means that we needed to gather a broad range of metrics to ascertain whether or not the system can cope with various loads. These are the sub assignments that ended up being executed during the project.

The sub assignments are:

\begin{itemize} %change to what we did
