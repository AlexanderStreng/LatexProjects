...
\label{sec:kdb}
The knowledge database was initially designed for a centralized platform, which is why, when the research question about switching to heterarchical came up, an agreement was reached that the database needed updating. Around the same time that this happened, reconfiguration was also being discussed, and this was yet another reason to alter the database structure.

The new design incoporated module location and calibration data for the equiplet modules. The full design can be seen in the figure below.
