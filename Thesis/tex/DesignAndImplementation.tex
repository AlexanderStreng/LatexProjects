...
\textbf{MAYBE EASE INTO THESE A LITTLE BIT BETTER. write smth about how where going in depth on planning / scheduling.}\\
...
\section{Simulation}
% todo: short explanation about the simulation? why it was made, what it's primary purpose is, grid + travel matrix & error stuff
...
\subsection{Mechanics} %any other subsections? There's mechanics, and gui so far..
%Single threaded with updateables
...
%originally developed for MAS, implemented here
