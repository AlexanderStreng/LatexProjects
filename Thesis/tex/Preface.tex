...
\subsection*{MoSCoW}
MoSCoW is a requirements prioritization technique. The 'o's in the acronym are there just to make it pronouncable. The capitalized letters stand for:

\begin{description}
\item[M]ust have this requirement to meet the business needs.
\item[S]hould have this requirement if possible, but project success does not rely on it.
\item[C]ould have this requirement if it does not affect anything else in the project.
\item[W]ould like to have this requirement later, but it won't be delivered this time.
\end{description}
